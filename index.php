...
//↓ if(!empty($_POST)) ＝　投稿ボタンがクリックされたならば
if(!empty($_POST)) {
  if ($_POST['message'] !== '') {
    $message = $db->prepare('INSERT INTO posts (member_id, message, reply_message_id, created) VALUES(?,?,?,NOW());');
...
<html lang="ja">
  ...
  <?php foreach ($posts as $post): ?>
      <div class="msg">
        ...
        ENT_QUOTES)); ?>" width="48" height="48" alt="<?php print(htmlspecialchars($post['name'], ENT_QUOTES)
      ); ?>" />
